...
define config.name = _("The Jackbox Party Pack 8")
...
define config.version = "Build5.1.2"
...
define gui.about = _p("""
Данная игра является шуткой не на первое апреля, но и не на второе и разработанна кричур оф стилом

Права к оригинальной игре и саундтреку пренадлежат компании Jackbox Games.

Все права на персонажей и саундтрек из Undertale принадлежат Toby Fox

Игра сделана человеком под ником "кричур оф car". 

Следите за обновлениями на https://gamejolt.com/games/tjpp8nofake/927824 

или на https://costil-studios.itch.io/tjpp8nofake
""")
...
define build.name = "TheJackboxPartyPack8"
...
define config.main_menu_music = "audio/music/startmenu.ogg"
...
define config.save_directory = "The Jackbox Party Pack 8"
